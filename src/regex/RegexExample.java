...
public class RegexExample {
    public static void main(String[] args) {
        String fourDigigtsNumbersPattern = "\\d{4}";
        RegexTester tester = new RegexTester(fourDigigtsNumbersPattern);
        tester.validate("2002");
        tester.validate("1996");
        tester.validate("765432");
        tester.validate("7uy6t5r43e");
